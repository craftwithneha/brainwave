...
const Hero = () => {
  ...
  return (
   ...
   id="hero"
   >
   <div className="contaier relative" ref={parallaxRef} >
     ...
     text-center  mb-[4rem] md:mb-20 lg:mb:[6rem]">
      <h1 className="h1 mb-6">
       ...
       >Unleash the power of AI within Brainwave,
        Upgarde your productivity with Brainwave, the open AI chat app.
       </p>
        ...
        bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
             ...
             overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                translate-y-[8%] md:scale-1[1] 
                md:translate-y-[10%] lg:-traslate-y-[23%]"
                width={1024}
                height={490}
                alt="AI"
                ...
                md:right-auto md:buttom-8 md:w-[31rem] md:-translate-x-1/2"/>
           ...
           <div className="absolute -top-[54%] left-1/2
             w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[104%]" >
    ...
    <CompanyLogos className="hidden realtive z-10 mt-20 lg:block"/>
   </div>
   <BottomLine/>
   </Section>
  )
